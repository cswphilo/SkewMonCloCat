...
In this section we introduce the sequent calculus for our skew variant of non-commutative multiplicative intuitionistic linear logic (\NMILL), that we call \SkNMILL.
