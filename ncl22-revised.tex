...
One might try a similar idea in the skew monoidal \emph{non-closed} case \cite{uustalu:sequent:2018} to solve the type 1 non-determinism, i.e., to prioritize $\pass$ over $\tr$ by requiring the first premise of the latter to be a sequent in phase $\F$.
