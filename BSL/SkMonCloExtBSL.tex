	 ...
	 \begin{proposition}
		\begin{displaymath}
			\infer[\lright^{*}]{S \mid \Gamma \vdash^{x}_{\RI} \ldbc \Delta \mid C\rdbc_{\lolli} }{
				\deduce{S \mid \Gamma , \Delta \vdash^{x}_{\RI} C}{f}
			}
		\end{displaymath}
		is admissible.
	 \end{proposition}
	 \begin{proof}
		Proof is done by induction on $\Delta$, if 
		\begin{itemize}
			\item $\Delta = [ \text{ } ]$, then $\lright^{*} \text{ } f \defeq f$;
			\item $\Delta = A , \Delta'$, then $\lright^{*} \text{ } f \defeq \lright \text{ } (\lright^{*} \text{ } f)$, i.e.
			\begin{displaymath}
                \begin{array}{ccc}
                \proofbox{
		  ...
		  \begin{displaymath}
			...
			\infer[\tr]{T \mid \Gamma , \Lambda \vdash_{\F} \ldbc \Gamma' , \Delta \mid A \ot B \rdbc_{\lolli} \ot C}{
				\infer[\lright^{*}]{T \mid \Gamma \vdash^{\bullet}_{\RI} \ldbc \Gamma' , \Delta \mid A \ot B \rdbc_{\lolli}}{
					\infer[\mathsf{sw}]{T \mid \Gamma , \Gamma' , \Delta \vdash^{\bullet}_{\RI} A \ot B}{
						\infer[\tr]{T \mid \Gamma , \Gamma' , \Delta \vdash^{\bullet}_{\F} A \ot B}{
							\deduce{T \mid \Gamma , \Gamma' \vdash^{\bullet}_{\RI} A}{f}
							&
							\deduce{{-} \mid \Delta \vdash_{\RI} B}{f'}
						}
        ...
        \begin{align*}
            ...
            \infer[\lright]{S \mid \Gamma_{00} , \Gamma_{01} \vdash^{x}_{\RI} \ldbc A , \Gamma'_1 \mid C \rdbc_{\lolli}}{
                \infer[\ex]{S \mid A^{x} \spl \Gamma_{00} , \Gamma_{01} \vdash^{x}_{\C} \ldbc \Gamma'_1 \mid C \rdbc_{\lolli}}{
                    \infer[\RI 2 \C]{S \mid \Gamma_{00} , A^{x} , \Gamma_{01} \vdash^{x}_{\C} \ldbc \Gamma'_1 \mid C \rdbc_{\lolli}}{
