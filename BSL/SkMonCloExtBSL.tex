...
\begin{equation}\label{fig:circeq:sym}
	\footnotesize
  \begin{array}{rlll}
    \unitl \text{ } (\ex_{A , B} \text{ } f) &\circeq \text{ } \ex_{A , B} \text{ } (\unitl \text{ } f) &&f: {-} \mid \Gamma , A , B , \Delta \vdash C
    \\
    \pass \text{ } (\ex_{A , B} \text{ } f) &\circeq \text{ } \ex_{A , B} \text{ } (\pass \text{ } f) &&f : A' \mid \Gamma , A , B , \Delta \vdash C
    \\
    \tl \text{ } (\ex_{A , B} \text{ } f) &\circeq \text{ } \ex_{A , B} \text{ } (\tl \text{ } f) &&f : A' \mid B' , \Gamma , A , B , \Delta \vdash C
    \\
    \tr \text{ }(\ex_{A , B} \text{ } f , g) &\circeq \text{ } \ex_{A , B} \text{ } (\tr \text{ } (f , g)) &&f : S \mid \Gamma_0 , A , B , \Gamma_1 \vdash A' , g : {-} \mid \Delta \vdash B'
    \\
    \tr \text{ } (f , \ex_{A , B} \text{ } g) &\circeq \text{ } \ex_{A , B} \text{ } (\tr \text{ } (f , g)) &&f : S \mid \Gamma \vdash A' , g : {-} \mid \Delta_0 , A , B , \Delta_1 \vdash B'
    \\
    \lleft \text{ } (\ex_{A , B} \text{ } f , g) &\circeq \text{ } \ex_{A , B} \text{ } (\lleft \text{ } (f , g)) &&f : {-} \mid \Gamma_0 , A , B , \Gamma_1 \vdash A' , g : B' \mid \Delta \vdash C
    \\
    \lleft \text{ } (f , \ex_{A , B} \text{ } g) &\circeq \text{ } \ex_{A , B} \text{ } (\lleft \text{ } (f , g)) &&f : {-} \mid \Gamma \vdash A' , g : B' \mid \Delta_0 , A , B , \Delta_1 \vdash C
    \\
    \lright \text{ } (\ex_{A , B} \text{ } f) &\circeq \text{ } \ex_{A , B} \text{ } (\lright \text{ } f) &&f : S \mid \Gamma , A , B , \Delta , A' \vdash B'
	\\
	\ex_{A , B} \text{ } (\ex_{A' , B'} \text{ } f) &\circeq \text{ } \ex_{A' , B'} \text{ } (\ex_{A , B} \text{ } f) &&f: S \mid \Gamma , A , B , \Delta , A' , B' , \Lambda \vdash C
	\\
	\ex_{B , A} \text{ } (\ex_{A , B} \text{ } f) &\circeq \text{ } f &&f: S \mid \Gamma , A , B , \Delta \vdash C
	\\
