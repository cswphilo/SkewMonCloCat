...
We consider a skew version of non-commutative intuitionistic linear logic with additive connectives which is presented by extending (\ref{eq:seqcalc}) with linear implication $\lolli$ and following two rules:
\begin{displaymath}
  \begin{array}{c}
  ...
  \end{array}
\end{displaymath}
Categorical semantics of the sequent calculus is skew monoidal closed categories with products and coproducts.
