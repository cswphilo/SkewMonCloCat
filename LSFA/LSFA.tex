...
\begin{theorem}
  ...
  \begin{displaymath}
    ...
    \end{array}
  \end{displaymath}
  Another interesting fact about the additive connectives is that $\andli$ in context ($\andli^{\mathsf{C}}$) are admissible however $\orl^{\mathsf{C}}$ in context is not admissible only when $A = B = \I$.
  \begin{displaymath}
    \begin{array}{c}
      \proofbox{
