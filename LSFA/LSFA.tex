...
We introduce a congruence relation $\circeq$ on the sets of derivations generated by the rules in (\ref{eq:seqcalc}). 
\begin{figure}[t]
  \begin{equation}
  \label{fig:circeq}
  \footnotesize
...
\section{Categorical Semantics}\label{sec:categorical}
  A \emph{skew monoidal category} $\mathbb{C}$ is a category with a unit object $\I$, a functor $\ot : \mathbb{C} \times \mathbb{C} \rightarrow \mathbb{C}$
