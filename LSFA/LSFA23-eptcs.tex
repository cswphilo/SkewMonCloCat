...
In the latter setting, the situation is more complicated than the skew one, since there could be more than two formulae that one can focus on in the synchronous phase.
