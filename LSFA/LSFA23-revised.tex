...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item If $f = \andr \ (f_1, f_2)$, then by inductive hypothesis we have $fs_1 : [S \mid \Gamma \vdash_{\LI} P_i]_{i \in [1 , \dots , n]}$ and $fs_2 : [S \mid \Gamma \vdash_{\LI} P'_i]_{i \in [1 , \dots , m]}$. Take $fs$ as the concatenation of $fs_1$ and $fs_2$.
  \end{itemize}
\end{proof}
...
We include a new tag $\tT$ for $\top$. The validity condition for lists of tags is updated as follows: ($i$) $\tT$ or $\tE \in l$, ($ii$) for any $t \in l$, $t = \tT$, or ($iii$) both $\tCone \in l$ and $\tCtwo \in l$. 
